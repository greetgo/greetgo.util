...
public class CopyOfGpenPropertyView extends ViewPart {
  
  /**
   * The ID of the view as specified by the extension.
   */
  public static final String ID = "kz.greepto.gpen.views.gpen.GpenPropertyView";
  ...
  public void createPartControl(Composite parent) {
    ...
    PlatformUI.getWorkbench().getHelpSystem()
        .setHelp(viewer.getControl(), "kz.greepto.gpen.viewer");
    makeActions();
    hookContextMenu();
  ...
  private void hookContextMenu() {
    ...
    menuMgr.addMenuListener(new IMenuListener() {
      public void menuAboutToShow(IMenuManager manager) {
        CopyOfGpenPropertyView.this.fillContextMenu(manager);
      }
    });
  ...
  private void showMessage(String message) {
    MessageDialog.openInformation(viewer.getControl().getShell(), "Gpen Property View", message);
  }
