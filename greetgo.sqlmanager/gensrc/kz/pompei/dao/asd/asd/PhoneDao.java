...
public interface PhoneDao {
  ...
  Phone loadAt(@Param("ts")Date ts, @Param("person")long person, @Param("annType")AnnotationType annType);
  ...
  @Insert("insert into m_phone_type (person, annType, type) values (#{person}, #{annType}, #{type})")
  void setType(@Param("person")long person, @Param("annType")AnnotationType annType, @Param("type")String type);
  @Insert("insert into m_phone_value (person, annType, value) values (#{person}, #{annType}, #{value})")
  void insValue(Phone phone);
  @Insert("insert into m_phone_value (person, annType, value) values (#{person}, #{annType}, #{value})")
  void setValue(@Param("person")long person, @Param("annType")AnnotationType annType, @Param("value")String value);
  ...
  @Insert("insert into m_phone_smsTemplate (person, annType, smsTemplate) values (#{person}, #{annType}, #{smsTemplate})")
  void setSmsTemplate(@Param("person")long person, @Param("annType")AnnotationType annType, @Param("smsTemplate")Long smsTemplate);
}
